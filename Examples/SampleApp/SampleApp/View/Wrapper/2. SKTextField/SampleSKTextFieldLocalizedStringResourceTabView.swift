//
//  SampleSKTextFieldLocalizedStringResourceTabView.swift
//  SwiftUI-Kit
//
...
struct SampleSKTextFieldLocalizedStringResourceTabView: View {
            ...
            Form {
                Section("`.focused(_:)`") {
                    SampleSKTextFieldBlock(
                        ...
                        field: {
                            SKTextField(
                                LocalizedStringResource("sample_resource_title"),
                                text: $boolHorizontalText,
                                axis: .horizontal
                            )
